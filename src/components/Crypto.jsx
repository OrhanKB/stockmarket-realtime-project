...
const Crypto = ({ data, gridMode, baseSocket }) => {
                ...
                <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100 p-4 relative">
                    <div className="mb-2 flex justify-between items-center">
                        <div className="flex items-center gap-2">
                            ...
                            <h3 className="text-lg font-bold text-gray-700">{selectedSymbol.replace('BINANCE:', '')} Chart</h3>
                        </div>
                ...
                {data.items.map((item, index) => (
                    ...
                    >
                        <div className="flex flex-col w-[45%]">
                            <span className="font-bold text-base text-gray-800 truncate">{item.symbol.replace('BINANCE:', '')}</span>
